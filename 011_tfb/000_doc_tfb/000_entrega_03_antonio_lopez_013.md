...
Una vez que poseemos las reflectancias brutas L1C y nuestra Verdad Terreno purificada y decodificada, los datos satelitales (gránulos enteros de 100x100 kilómetros) son aún demasiado masivos y heterogéneos para ser procesados por una tarjeta gráfica. Para resolver este cuello de botella, entra en juego el *script* de ingeniería de datos [`004_create_dataset.py`](../scripts/004_create_dataset.py). 
