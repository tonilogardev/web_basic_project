...
- **Paso 2. El Dilema Topográfico (Descarte del DEM):** Para solucionar el solapamiento entre las sombras de las montañas y las sombras de las nubes, la arquitectura inicial contempló inyectar el Modelo Digital de Elevaciones (DEM) de Cataluña. **Decisión:** Por criterios de simplicidad arquitectónica y viabilidad computacional, se descartó su integración para apostar exclusivamente por la pura termodinámica espectral (bandas SWIR), logrando un procesamiento ultrarrápido y ecológico (*Green Computing*). Sin embargo, este descarte intencionado del DEM provocó que el modelo presente debilidades algorítmicas al enfrentarse a las sombras topográficas puras, estableciendo así una línea de investigación prioritaria para el trabajo futuro.
