...
**Decisión:** **Se descarta** el uso del Modelo Digital de Elevaciones (DEM).
**Justificación:**
En primera instancia, se consideraba que era lo más lógico e imprescindible incluir el DEM por los siguientes supuestos teóricos:
- *Cota de Nieve:* La nieve está estrictamente condicionada a la altitud, proporcionando teóricamente una regla probabilística para discriminar nubes (baja altitud) de nieve (alta altitud).
- *Sombras Topográficas:* El bajo ángulo solar en invierno genera enormes sombras en las laderas de los Pirineos (confundibles con sombras de nubes), y se pensaba que inyectar el DEM ayudaría a la red a entender la orografía.

Sin embargo, **después de investigar en profundidad sobre el tema, se ha tenido que cambiar de idea y desecharlo**. Las bandas SWIR resuelven la dicotomía nube/nieve de forma óptica pura, y los algoritmos del estado del arte prescinden totalmente de él, evitando una inmensa y frágil complejidad de ingeniería de datos.

La justificación detallada y la bibliografía científica que avalan esta decisión final se recogen en el documento anexo: [006_DEM_not_DEM.md](006_DEM_not_DEM.md).
