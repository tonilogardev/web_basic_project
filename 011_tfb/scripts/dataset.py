"""
Clase base para la gestión del conjunto de datos en PyTorch.

Este módulo define la clase SentinelDataset, encargada de la carga asíncrona,
transformación y empaquetado de los tensores de entrada (imágenes multiespectrales)
y sus correspondientes máscaras de clasificación (SCL) como *Ground Truth*.
"""
