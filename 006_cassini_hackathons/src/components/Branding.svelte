...
<div class="branding-wrapper {isOpen ? 'is-open' : ''}">
  <button 
    ...
    aria-label={isOpen ? "Close information" : "View project information"}
  >
    {#if !isOpen}
    ...
    <div class="glass-panel">
      <div class="header-row">
        <div class="title-group">
          <h1>Sentinel Explorer</h1>
          <p class="tagline">CASSINI Hackathon - Blue Pixel</p>
        </div>
        <a href={repoUrl} target="_blank" rel="noopener noreferrer" class="repo-link" title="View GitHub">
